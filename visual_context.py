...
def analyze_visual_context(image_path: str, user_instruction: str) -> Tuple[str, float]:
    """
...
def get_global_analyzer() -> VisualContextAnalyzer:
    """Get or create a global analyzer instance."""
    global _global_analyzer
    if _global_analyzer is None:
        _global_analyzer = VisualContextAnalyzer()
